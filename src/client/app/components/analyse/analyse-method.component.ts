...
@Component({
  ...
  template: `
    ...
    <mat-form-field [formGroup]="form">    
      <mat-select placeholder="{{ 'SELECT_METHOD' | translate}}" [formControlName]="inputName" (selectionChange)="methodEmitter.emit($event.value)" [value]="methods[0].method" required>
