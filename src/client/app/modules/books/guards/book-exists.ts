...
export class BookExistsGuard implements CanActivate {
  constructor(
    private bookStore: Store<IAppState>,
    private collectionStore: Store<IAppState>,
  ...
  hasBookInApi(id: string): Observable<boolean> {
    ...
    return this.googleBooks
      .retrieveBook(id)
      .map(bookEntity => new BookAction.LoadAction(bookEntity))
      .do((action: BookAction.LoadAction) => this.bookStore.dispatch(action))
      .map(book => !!book)
      .catch(() => {
