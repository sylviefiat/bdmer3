...
import { CollectionEffects } from './index';
...
describe('CollectionEffects', () => {
  ...
  describe('loadCollection$', () => {
    it('should return a collection.LoadSuccessAction, with the books, on success', () => {
      const action = new CollectionAction.LoadAction();
      const completion = new CollectionAction.LoadSuccessAction([book1, book2]);
    ...
    it('should return a collection.LoadFailAction, if the query throws', () => {
      const action = new CollectionAction.LoadAction();
      const error = 'Error!';
      const completion = new CollectionAction.LoadFailAction(error);
  ...
  describe('addBookToCollection$', () => {
    it('should return a collection.AddBookSuccessAction, with the book, on success', () => {
      const action = new CollectionAction.AddBookAction(book1);
      const completion = new CollectionAction.AddBookSuccessAction(book1);
    ...
    it('should return a collection.AddBookFailAction, with the book, when the db insert throws', () => {
      const action = new CollectionAction.AddBookAction(book1);
      const completion = new CollectionAction.AddBookFailAction(book1);
      const error = 'Error!';
    ...
    describe('removeBookFromCollection$', () => {
      it('should return a collection.RemoveBookSuccessAction, with the book, on success', () => {
        const action = new CollectionAction.RemoveBookAction(book1);
        const completion = new CollectionAction.RemoveBookSuccessAction(book1);
      ...
      it('should return a collection.RemoveBookFailAction, with the book, when the db insert throws', () => {
        const action = new CollectionAction.RemoveBookAction(book1);
        const completion = new CollectionAction.RemoveBookFailAction(book1);
        const error = 'Error!';
