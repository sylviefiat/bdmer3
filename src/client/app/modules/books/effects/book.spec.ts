...
import { BookEffects, SEARCH_SCHEDULER, SEARCH_DEBOUNCE } from './index';
...
describe('BookEffects', () => {
  ...
  describe('search$', () => {
    it('should return a new book.SearchCompleteAction, with the books, on success, after the de-bounce', () => {
      ...
      const action = new BookAction.SearchAction('query');
      const completion = new BookAction.SearchCompleteAction(books);
    ...
    it('should return a new book.SearchCompleteAction, with an empty array, if the books service throws', () => {
      const action = new BookAction.SearchAction('query');
      const completion = new BookAction.SearchCompleteAction([]);
      const error = 'Error!';
    ...
    it(`should not do anything if the query is an empty string`, () => {
      const action = new BookAction.SearchAction('');
